...
export const cDragonBaseUri = `https://raw.communitydragon.org/latest/plugins/rcp-be-lol-game-data/global/default`;
...
export const perks: Record<PerkId, any> = {
  ...
  5003: {
    ...
    recommendationDescriptor: '',
    iconPath: `/lol-game-data/assets/v1/perk-images/StatMods/StatModsMagicResIcon.MagicResist_Fix.png`,
    endOfGameStatDescs: [],
    recommendationDescriptorAttributes: {},
    stats: {
      mr: 8,
        ...
        leveling: [
          {
            ...
            unitsText: `Adaptive damage and render the target Exposed for 6 seconds.`,
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/precision/lethaltempo/lethaltempotemp.png`,
      },
      {
        description: `Stacks expire by one every 0.<small>5</small> seconds when the duration ends.`,
      },
    ],
  },
  8009: {
  ...
  8010: {
    ...
    subskills: [
      ...
      {
        description: `<a href="/wiki/Damage_over_time" title="Damage over time">Damage over time</a> effects and ongoing sources of damage grant stacks only once every 5 seconds.`,
      },
    ],
  },
  8014: {
    ...
    subskills: [
      {
        ...
        locked: true,
        img: `${cDragonBaseUri}/v1/perk-images/styles/precision/coupdegrace/coupdegrace.png`,
      },
    ],
  },
  8017: {
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/precision/cutdown/cutdown.png`,
      },
    ],
  },
  8021: {
        ...
        leveling: [
          {
            ...
            increasedStat: 'bonus_movespeed',
            values: 5,
            unitsText: `movement speed while out of combat.`,
            children: [
              {
                values: 8,
  ...
  8106: {
    ...
    subskills: [
      {
        description: `Gain 6 (+ 5 per <i>Bounty Hunter</i> stack) <a href="/wiki/Ultimate_haste" class="mw-redirect" title="Ultimate haste">ultimate haste</a>, up to 31 at 5 stacks.`,
        leveling: [
          {
            name: 'Passive:',
        ...
        locked: true,
        img: `${cDragonBaseUri}/v1/perk-images/styles/domination/ultimatehunter/ultimatehunter.png`,
      },
      {
        description: `Earn a <i>Bounty Hunter</i> <a href="/wiki/Stack" title="Stack">stack</a> whenever scoring a <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Takedown"><a href="/wiki/Takedown" title="Takedown"><img alt="Damage rating.png" src="/wiki/images/Damage_rating.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Takedown" title="Takedown">takedown</a></span> against an enemy champion, up to one per unique champion.`,
        leveling: [
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: 0,
            unitsText: `Damaging basic attacks, abilities, item effects, and summoner spells, as well as the application of  crowd control and damage over time effects, generate stacks against enemy  champions, up to one per attack or cast per champion`,
  ...
  8120: {
    ...
    subskills: [
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: 1,
            unitsText: `every Ghost Poro spawned and whenever your Ghost Poro spots an enemy champion, up to 10 stacks, for a maximum of 12 bonus Attack Damage or 20 Ability Power`,
            children: [
              {
                values: 0,
                unitsText: 'Adaptive',
      ...
      {
        description: `<span class="template_sbc"><b>Adaptive:</b></span> Grants bonuses in the stat you already have the most bonuses in. <i>Defaults to the first listed.</i>`,
      },
    ],
  },
  8124: {
        ...
        leveling: [
          {
            ...
            valuesIsBasedOnLevel: true,
            unitsText: `bonus true damage to enemy  champions affected by certain crowd control effects.`,
        ...
        leveling: [
          {
            ...
            valuesIsBasedOnLevel: true,
            unitsText: `Adaptive damage and, after a 1.75-second delay, reap 1 Soul`,
            children: [
              {
                values: 5,
                unitsText: 'per Soul',
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: 0,
            unitsText: `This effect deals either physical or magic damage depending on the damage contribution from your  attack damage and  ability power to the effect's damage formula.\nGreater bonus damage from the  AD ratio → Physical damage\nGreater bonus damage from the  AP ratio → Magic damage\nIf the damage contribution of  AD and  AP are zero or otherwise equal, the damage type depends on the effect's particular default.`,
  ...
  8134: {
    ...
    subskills: [
      {
        description: `<span class="template_sbc"><b>Passive:</b></span> Gain 20 (+ 6 per <i>Bounty Hunter</i> stack) <a href="/wiki/Ability_haste#Increasing_item_haste" class="mw-redirect" title="Ability haste">item haste</a>, up to 50 at 5 stacks.`,
        leveling: [
          {
            name: 'Passive:',
            raw: ` Gain 20 (+ 6 per Bounty Hunter stack) item haste, up to 50 at 5 stacks.`,
            increasedStat: 'itemHaste',
            effectType: 'Gain',
            values: 20,
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/domination/ingenioushunter/ingenioushunter.png`,
      },
      {
        description: `Earn a <i>Bounty Hunter</i> <a href="/wiki/Stack" title="Stack">stack</a> whenever scoring a <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Takedown"><a href="/wiki/Takedown" title="Takedown"><img alt="Damage rating.png" src="/wiki/images/Damage_rating.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Takedown" title="Takedown">takedown</a></span> against an enemy champion, up to one per unique champion.`,
        leveling: [
    ...
    subskills: [
      {
        ...
        locked: true,
        img: `${cDragonBaseUri}/v1/perk-images/styles/domination/zombieward/zombieward.png`,
      },
      {
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: 1,
            unitsText: `every Zombie Ward spawned, up to 10, for a maximum of 12 bonus Attack Damage or 20 Ability Power`,
            children: [
              {
                values: 0,
                unitsText: 'Adaptive',
  ...
  8138: {
    ...
    subskills: [
      {
        description: `<span class="template_sbc"><b>Passive:</b></span> Collect 1 <i>Eyeball</i> whenever scoring a <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Takedown"><a href="/wiki/Takedown" title="Takedown"><img alt="Damage rating.png" src="/wiki/images/Damage_rating.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Takedown" title="Takedown">takedown</a></span> against an enemy champion, up to 10.`,
        leveling: [
          {
            name: 'Passive:',
            ...
            effectType: 'Gain',
            values: 1,
            unitsText: `1 Eyeball whenever scoring a  takedown against an enemy champion, up to 10.`,
            pre: `Collect 1 Eyeball whenever scoring a  takedown against an enemy champion, up to 10.`,
            user: 'player',
            units: `total_1 eyeball whenever scoring a  takedown against an enemy champion, up to 10.`,
          },
        ],
        img: `${cDragonBaseUri}/v1/perk-images/styles/domination/eyeballcollection/eyeballcollection.png`,
      },
      {
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: 1,
            unitsText: `Eyeball collected, up to 12 bonus Attack Damage or 20 Ability Power`,
            children: [
              {
                values: 0,
                unitsText: 'Adaptive',
          ...
          {
            name: 'Completing your collection:',
      ...
      {
        description: `<span class="template_sbc"><b>Adaptive:</b></span> Grants bonuses based on which stat you already have the most bonuses for. <i>Defaults to the first listed.</i>`,
        leveling: [
          {
            name: 'Adaptive:',
            ...
            effectType: 'Gain',
            values: 0,
            unitsText: `Grants bonuses based on which stat you already have the most bonuses for`,
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/domination/tasteofblood/greenterror_tasteofblood.png`,
      },
      {
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/domination/suddenimpact/suddenimpact.png`,
      },
      {
        description: `The triggering damage will benefit from the penetration. This effect will trigger as soon as the conditions are met.`,
      },
    ],
  },
  8210: {
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/sorcery/transcendence/transcendence.png`,
      },
    ],
  },
  8214: {
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/sorcery/summonaery/summonaery.png`,
      },
      {
        description: `<i>Aery</i> applies her effects to the affected champion upon arrival. She then lingers on the target for <span class="basic-tooltip" style="border-bottom:1px dotted gray;cursor:help;" title="Slightly less than this duration">2 seconds</span> before flying back to the user, and cannot be sent out again until she returns. While on her way back, she is <span class="basic-tooltip" style="border-bottom:1px dotted gray;cursor:help;" title="200 initial return speed">initially very slow</span>, but <span class="basic-tooltip" style="border-bottom:1px dotted gray;cursor:help;" title="+10 speed per 51 units she travels">gradually accelerates</span>, and <span class="basic-tooltip" style="border-bottom:1px dotted gray;cursor:help;" title="+2000 speed per 51 units traveled after coming within 200 units of the user">can be picked up by moving near her</span>.`,
        leveling: [
          {
            name: 'Passive:',
            ...
            effectType: 'Gain',
            values: 2,
            unitsText: `then lingers on the target for 2 seconds before flying back to the user, and cannot be sent out again until she returns`,
            ...
            user: 'target',
            units: `total_then lingers on the target for 2 seconds before flying back to the user, and cannot be sent out again until she returns`,
          },
          {
            name: 'Passive:',
            ...
            effectType: 'Gain',
            values: 0,
            unitsText: `While on her way back, she is initially very slow, but gradually accelerates, and can be picked up by moving near her.`,
  ...
  8224: {
    ...
    name: 'Nullifying Orb',
    majorChangePatchVersion: '',
    tooltip: `When you take magic damage that would reduce your Health below 30%, gain a shield that absorbs <font color='#ffffff'>@f2@</font> (+<scaleAD>@f3@</scaleAD>) (+<scaleAP>@f4@</scaleAP>) magic damage for 4s.<br><br>Cooldown: 60s<br><hr><br>Total Magic Damage Blocked: @f1@`,
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/sorcery/nullifyingorb/pokeshield.png`,
      },
    ],
  },
  8226: {
        ...
        leveling: [
          {
            ...
            effectType: 'Unique',
            values: 2,
            unitsText: `an enemy  champion with an ability permanently increases your  maximum mana by 25, up to 250 mana`,
          ...
          },
          {
            ...
            effectType: 'Gain',
            values: 0,
            unitsText: `Mana gained from this effect preserves your current mana.`,
            pre: `Mana gained from this effect preserves your current mana.`,
            user: 'player',
            units: 'total_mana',
          },
        ],
        img: `${cDragonBaseUri}/v1/perk-images/styles/sorcery/manaflowband/manaflowband.png`,
      },
      {
        description: `After reaching <span style="color: #0099CC; white-space:normal">250 <b>bonus</b> mana</span>, permanently restore <span style="color: #0099CC; white-space:normal">1% of your <b>missing</b> mana</span> every 5&nbsp;seconds.`,
        leveling: [
          {
            name: 'Passive:',
            ...
            values: 2,
            valuesIsPercent: true,
            unitsText: `of your missing mana every 5 seconds.reaching 250 bonus mana, permanently restore 1`,
        ...
        leveling: [
          {
            ...
            valuesIsBasedOnLevel: true,
            unitsText: `or magic damage to enemies within a  140 radius upon impact.`,
            children: [
              {
                values: 35,
                valuesIsPercent: true,
  ...
  8230: {
    ...
    name: 'Phase Rush',
    majorChangePatchVersion: '',
    tooltip: `Hitting an enemy champion with 3 attacks or <b>separate</b> abilities within 4s grants <speed>15 - 40% Move Speed</speed> based on level and 75% Slow Resistance. <hr>This is increased to <speed>30 - 60% Move Speed</speed> for Melee champions.<hr>Duration: 3s<br>Cooldown: @f4@s<br>Haste Bonus: @f2@%`,
    ...
    path: 'Sorcery',
    slot: 'Keystone',
    cooldown: `<span class="pp-tooltip" style="position:relative; border-bottom:1px dotted; cursor:help;" data-start="30;" data-finish="10;" data-bot_values="30;28.82;27.65;26.47;25.29;24.12;22.94;21.76;20.59;19.41;18.24;17.06;15.88;14.71;13.53;12.35;11.18;10" data-top_values="">30 − 10 (based on level)</span>`,
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/sorcery/phaserush/phaserush.png`,
      },
    ],
  },
  8232: {
    ...
    name: 'Waterwalking',
    majorChangePatchVersion: '',
    tooltip: `Gain <speed>25 Move Speed</speed> and an <lol-uikit-tooltipped-keyword key='LinkTooltip_Description_Adaptive'><font color='#48C4B7'>adaptive</font></lol-uikit-tooltipped-keyword> bonus of up to 18 Attack Damage or 30 Ability Power (based on level) when in the river.`,
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/sorcery/waterwalking/waterwalking.png`,
      },
      {
        description: `<span class="template_sbc"><b>Adaptive:</b></span> Grants bonuses based on which stat you already have the most bonuses for. <i>Defaults to the first listed.</i>`,
      },
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/sorcery/absolutefocus/absolutefocus.png`,
      },
      {
        description: `<span class="template_sbc"><b>Adaptive:</b></span> Grants bonuses based on which stat you already have the most bonuses for. <i>Defaults to the first listed.</i>`,
        leveling: [
  ...
  8234: {
    ...
    subskills: [
      {
        description: `<span class="template_sbc"><b>Passive:</b></span> All <a href="/wiki/Movement_speed" title="Movement speed">movement speed</a> <b>bonuses</b> increase in effectiveness by 7%.`,
        leveling: [
          {
            name: 'Passive:',
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/sorcery/gatheringstorm/gatheringstorm.png`,
      },
      {
        description: `<span class="template_sbc"><b>Adaptive:</b></span> Grants bonuses based on which stat you already have the most bonuses for. <i>Defaults to the first listed.</i>`,
        leveling: [
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/sorcery/scorch/scorch.png`,
      },
    ],
  },
  8242: {
    ...
    name: 'Unflinching',
    majorChangePatchVersion: '',
    tooltip: `Gain 5% Tenacity and 5% Slow Resist. These values increase by up to an additional 20% Tenacity and 20% Slow Resist based on missing health. Maximum value achieved at 30% health. <br>Current Bonus Tenacity: @f1@%<br>Current Bonus Slow Resist: @f2@%<br><br>Total combat time with increased resistances: @f6@ seconds.`,
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/sorcery/unflinching/unflinching.png`,
      },
    ],
  },
  8275: {
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/sorcery/nimbuscloak/6361.png`,
      },
    ],
  },
  8299: {
    ...
    subskills: [
      {
        ...
        leveling: [
          ...
          },
          {
            ...
            values: 1,
            valuesIsPercent: true,
            unitsText: `increased damage while below 30increases further based on your missing health, up to 11`,
            pre: `This increases further based on your missing health, up to 11% increased damage while below 30% maximum health.`,
            user: 'player',
            units: 'missing_hp',
          },
        ],
        img: `${cDragonBaseUri}/v1/perk-images/styles/sorcery/laststand/laststand.png`,
      },
    ],
  },
  8304: {
  ...
  8306: {
    ...
    subskills: [
      ...
      {
        description: `<i>Uses Quick Casting by default, which requires the Active to be held and the Recast to occur on release.</i>`,
      },
    ],
  },
  8313: {
    ...
    name: 'Perfect Timing',
    majorChangePatchVersion: '',
    tooltip: `Begin the game with a Commencing Stopwatch that transforms into a Stopwatch after 14 minutes. Each takedown you acquire reduces this timer by 120 seconds.<br><br>Stopwatch can be used for a one time 2.5 second Stasis effect.`,
    ...
    recommendationDescriptor: '',
    iconPath: `/lol-game-data/assets/v1/perk-images/Styles/Inspiration/PerfectTiming/PerfectTiming.png`,
  ...
  8321: {
    ...
    majorChangePatchVersion: '',
    tooltip: `You can enter debt to buy items. The amount you can borrow increases over time.<br><br>Lending Fee: 50 gold<br><hr><br>Debt limit: Available at 2 minutes<br>Future Purchases: @f3@`,
    shortDesc: 'You can enter debt to buy items.',
    longDesc: `You can enter debt to buy items. The amount you can borrow increases over time.<br><br>Lending Fee: 50 gold<br>Debt limit: 150 + 5/min<br>(Debt doesn't become available until 2 minutes)`,
    recommendationDescriptor: '',
  ...
  8347: {
    ...
    subskills: [
      {
        description: `<span class="template_sbc"><b>Passive:</b></span> Gain 18 <a href="/wiki/Ability_haste#Increasing_summoner_spell_haste" class="mw-redirect" title="Ability haste">summoner spell haste</a> and 10 <a href="/wiki/Ability_haste#Increasing_item_haste" class="mw-redirect" title="Ability haste">item haste</a>.`,
        leveling: [
          {
            name: 'Passive:',
            increasedStat: 'summonerSpellHaste',
            effectType: 'Gain',
            values: 18,
            unitsText: `summoner spell haste.`,
            user: 'player',
            units: '',
          },
          {
            ...
            effectType: 'Gain',
            values: 10,
            unitsText: `item haste.`,
            user: 'player',
            units: '',
          },
        ],
        locked: true,
        img: `${cDragonBaseUri}/v1/perk-images/styles/inspiration/cosmicinsight/cosmicinsight.png`,
      },
    ],
  },
  8351: {
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/inspiration/unsealedspellbook/unsealedspellbook.png`,
      },
      {
        description: `Your first swap becomes available after 6 minutes, with an initial 300 second cooldown. Selecting a unique summoner spell reduces the swap cooldown by 25 seconds. You must swap to 3 different summoner spells before returning to one you've already used.`,
      },
      {
        description: `Selecting a summoner spell puts it on a 5 second cooldown.`,
      },
      {
        description: `Using a selected summoner spell puts the summoner spell in the same slot on a 10 second cooldown.`,
      },
    ],
  },
  8369: {
    ...
    subskills: [
      ...
      {
        description: `<i>First Strike</i> will be placed on full cooldown after being struck by an enemy champion before you strike them.`,
      },
    ],
  },
  8401: {
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/resolve/approachvelocity/approachvelocity.png`,
      },
    ],
  },
  8429: {
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/resolve/conditioning/conditioning.png`,
      },
    ],
  },
  8437: {
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/resolve/graspoftheundying/graspoftheundying.png`,
      },
    ],
  },
  8439: {
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/resolve/secondwind/secondwind.png`,
      },
    ],
  },
  8446: {
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/resolve/demolish/demolish.png`,
      },
      {
        description: `<i>Demolish</i> cannot be triggered against the same turret again by anyone for 3.<small>5</small> seconds. Stacks expire by one every 1 second if you move out of range.`,
        leveling: [],
      },
      {
  ...
  8451: {
    ...
    subskills: [
      {
        description: `<span class="template_sbc"><b>Passive:</b></span> Every 8 <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Monster"><a href="/wiki/Monster" title="Monster"><img alt="Monster icon.png" src="/wiki/images/Monster_icon.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Monster" title="Monster">monsters</a></span> or enemy <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Minion"><a href="/wiki/Minion_(League_of_Legends)" title="Minion (League of Legends)"><img alt="Minion icon.png" src="/wiki/images/Minion_icon.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Minion_(League_of_Legends)" title="Minion (League of Legends)">minions</a></span> that die near you permanently generates a <a href="/wiki/Stack" title="Stack">stack</a>. Each stack grants <span style="color: #1F995C; white-space:normal">3 <b>bonus</b> health</span>. This effect can stack indefinitely.`,
        leveling: [],
        img: `${cDragonBaseUri}/v1/perk-images/styles/resolve/overgrowth/overgrowth.png`,
      },
      {
        description: `After gaining 15 stacks (120 monsters or minions), you gain additional <span style="color: #1F995C; white-space:normal"><b>bonus</b> health</span> equal to <span style="color: #1F995C; white-space:normal">3.<small>5</small>% <b>maximum</b> health</span>.`,
        leveling: [
          {
            name: 'Bonus Health:',
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/resolve/revitalize/revitalize.png`,
      },
      {
        description: `Outgoing <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Heal"><a href="/wiki/Healing" title="Healing"><img alt="Heal power icon.png" src="/wiki/images/Heal_power_icon.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Healing" title="Healing">healing</a></span> and outgoing <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Shield"><a href="/wiki/Shield" title="Shield"><img alt="Hybrid resistances icon.png" src="/wiki/images/Hybrid_resistances_icon.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Shield" title="Shield">shielding</a></span> are increased by 10% on targets <span style="color: #1F995C; white-space:normal">below 40% of their <b>maximum</b> health</span>.`,
        leveling: [],
      },
      {
        description: `Incoming healing, incoming shielding, self-healing and self-shielding are increased by 10% while <b>you</b> are <span style="color: #1F995C; white-space:normal">below 40% of your <b>maximum</b> health</span>.`,
        leveling: [],
      },
    ],
  },
  ...
  8465: {
    ...
    path: 'Resolve',
    slot: 'Keystone',
    cooldown: `<span class="pp-tooltip" style="position:relative; border-bottom:1px dotted; cursor:help;" data-start="90;" data-finish="40;" data-bot_values="90;87.06;84.12;81.18;78.24;75.29;72.35;69.41;66.47;63.53;60.59;57.65;54.71;51.76;48.82;45.88;42.94;40" data-top_values="">90 − 40 (based on level)</span>`,
    range: `<span class="basic-tooltip" style="border-bottom:1px dotted gray;cursor:help;" title="Targeted Guard">Global</span>`,
    subskills: [
      {
        description: `<span class="template_sbc"><b>Passive:</b></span> While within 350 units of an allied <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Champion"><a href="/wiki/Champion" title="Champion"><img alt="Champion icon.png" src="/wiki/images/Champion_icon.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Champion" title="Champion">champion</a></span>, you raise your <i>Guard</i>. Allied champions you affect with <a href="/wiki/Unit-targeted" class="mw-redirect" title="Unit-targeted">unit-targeted</a> <a href="/wiki/Champion_ability" title="Champion ability">abilities</a> are also <i>Guarded</i> for 3 seconds, regardless of distance.`,
        leveling: [],
      ...
      {
        description: `<i>Guardian</i> only goes on <span style="white-space:nowrap"><a href="/wiki/Cooldown" title="Cooldown"><img alt="Cooldown icon.png" src="/wiki/images/Cooldown_icon.png" decoding="async" loading="lazy" width="15" height="15" class="lazyload"></a>&nbsp;cooldown</span> when the shield is triggered.`,
        leveling: [],
      },
    ],
  },
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/resolve/boneplating/boneplating.png`,
      },
    ],
  },
  9101: {
    ...
    name: 'Overheal',
    majorChangePatchVersion: '',
    tooltip: `Excess healing on you becomes a shield, for up to <scaleHealth>@f7@ Max Health</scaleHealth>.<br><br>Shield is built up from <scaleLevel>@f6@%</scaleLevel> of excess healing from yourself or any ally.<br><hr><br><b>Total damage blocked: <scaleAD>@f1@</scaleAD></b>`,
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/precision/overheal.png`,
      },
      {
        description: `After 6 seconds, the shield decays by 1% of its maximum value every 0.<small>25</small> seconds. Receiving healing or dealing or taking damage will refresh the shield duration to 6 seconds.`,
        leveling: [],
      },
    ],
  },
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/precision/legendbloodline/legendbloodline.png`,
      },
      {
        description: `<span class="template_sbc"><b>Legend:</b></span> Gain <i>Legend</i> stacks for every 100 points`,
        leveling: [
          {
            effectType: 'Stacks',
            units: 'legendStacks',
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/precision/legendalacrity/legendalacrity.png`,
      },
      {
        description: `<span class="template_sbc"><b>Legend:</b></span> Gain <i>Legend</i> stacks for every 100 points`,
        leveling: [
          {
            ...
            unitsText: ' Legend stacks',
            title: 'Legend Stacks',
            description: `<span class="template_sbc"><b>Legend:</b></span> Gain <i>Legend</i> stacks for every 100 points earned, up to 10:\n<ul><li>100 points for champion <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Takedown"><a href="/wiki/Takedown" title="Takedown"><img alt="Damage rating.png" src="/wiki/images/Damage_rating.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Takedown" title="Takedown">takedowns</a></span></li>\n<li>100 points for epic monster <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Takedown"><a href="/wiki/Takedown" title="Takedown"><img alt="Damage rating.png" src="/wiki/images/Damage_rating.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Takedown" title="Takedown">takedowns</a></span></li>\n<li>25 points for large monster kills</li>\n<li>4 points for minion kills</li></ul>`,
          },
        ],
        locked: true,
      },
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/precision/legendtenacity/legendtenacity.png`,
      },
      {
        description: `<span class="template_sbc"><b>Legend:</b></span> Gain <i>Legend</i> stacks for every 100 points`,
        leveling: [
  ...
  9111: {
    ...
    name: 'Triumph',
    majorChangePatchVersion: '',
    tooltip: `Takedowns restore 10% of your missing health and grant an additional 20 gold. <br><hr><br>Total health restored: <scaleAD>@f1@</scaleAD><br>Total bonus gold granted: <scaleAD>@f2@</scaleAD>`,
    ...
    subskills: [
      {
        ...
        img: `${cDragonBaseUri}/v1/perk-images/styles/precision/triumph.png`,
      },
    ],
  },
  9923: {
