import type { PerkStyle, Perk } from './perks';

export type StyleId = 8000 | 8200 | 8400 | 8300 | 8100;
export type PerkId =
  | 5001
  | 5002
  | 5003
...
export const perks: Record<PerkId, Perk> = {
        ...
        leveling: [
          {
            ...
            values: [
              ...
              114.12, 122.35, 130.59, 138.82, 147.06, 155.29, 163.53, 171.76,
              180,
            ],
            valuesIsBasedOnLevel: true,
            unitsText:
              'Adaptive damage and render the target Exposed for 6 seconds.',
            post: 'bonus Adaptive damage and render the target Exposed for 6 seconds',
            user: 'player',
            units: '',
          },
          {
            name: 'Exposed',
            effectType: 'Gain',
            increasedStat: 'percentDamageIncrease',
            user: 'target',
            values: [40, 180],
            valuesIsBasedOnLevel: true,
            units: '',
            unitsText: 'increased damage.',
          },
        ],
        ...
        leveling: [
          {
            name: 'Passive:',
            effectType: 'Stacks',
            increasedStat: 'lethalTempoStacks',
            min: 0,
            max: 6,
            values: 1,
          ...
          },
          {
            ...
            effectType: 'Gain',
            increasedStat: 'bonus_attackspeed',
            values: [
              10, 10, 11, 11, 11, 12, 12, 12, 13, 13, 13, 14, 14, 14, 15, 15,
              15, 15,
            ],
            valuesRanged: [
              5, 5, 6, 6, 6, 7, 7, 7, 8, 8, 8, 9, 9, 9, 10, 10, 10, 10,
            ],
            valuesIsBasedOnLevel: true,
            valuesIsPercent: true,
            unitsText: 'bonus attack speed for each stack',
            user: 'player',
        ...
        leveling: [
          {
            ...
            min: 0,
            max: 12,
            unitsText: ' stacks of Conqueror',
            description:
              'Gain (Melee 2 / Ranged 1) stacks from basic attacks and 2 stacks from abilities, spells, and item actives.',
            user: 'player',
            title:
              'Grants stacks of Conqueror, lasting for 5 seconds, refreshing on subsequent damage against champions, and stacking up to 12 times.',
            units: 'conquerorStacks',
          },
        ],
        locked: true,
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: [
              1.2, 1.29, 1.38, 1.46, 1.55, 1.64, 1.73, 1.82, 1.91, 1.99, 2.08,
              2.17, 2.26, 2.35, 2.44, 2.52, 2.61, 2.7,
            ],
            valuesIsBasedOnLevel: true,
            unitsText: 'Attack Damage or 2',
            children: [
              {
                values: 0,
                unitsText: 'Adaptive',
        ...
        leveling: [
          {
            ...
            values: [5, 15],
            valuesIsPercent: true,
            unitsText: 'increased damage (except  true damage) to champions',
            pre: 'Deal 5% to 15% increased damage',
            user: 'player',
            units: 'percentDamageIncrease',
          },
        ],
        ...
        leveling: [
          {
            ...
            effectType: 'Heal',
            values: [
              10, 15.29, 20.59, 25.88, 31.18, 36.47, 41.76, 47.06, 52.35, 57.65,
              62.94, 68.24, 73.53, 78.82, 84.12, 89.41, 94.71, 100,
            ],
            valuesIsBasedOnLevel: true,
            children: [
              {
          ...
          },
          {
            ...
            valuesIsPercent: true,
            user: 'player',
            unitsText: 'movement speed for 1 seconds.',
            units: '',
          },
          {
            name: 'Against  minions:',
        ...
        leveling: [
          {
            ...
            values: 5,
            unitsText:
              'movement speed while out of combat, up to 45 at 5 stacks.',
            children: [
              {
                values: 8,
                unitsText: 'per Bounty Hunter stack',
                user: 'player',
        ...
        leveling: [
          {
            ...
            user: 'player',
            units: 'bountyHunterStacks',
            unitsText: ' unique kills',
            min: 0,
            max: 5,
            title: 'Bounty Hunter stacks',
            description:
              'Earn a <i>Bounty Hunter</i> <a href="/wiki/Stack" title="Stack">stack</a> whenever scoring a <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Takedown"><a href="/wiki/Takedown" title="Takedown"><img alt="Damage rating.png" src="/wiki/images/Damage_rating.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Takedown" title="Takedown">takedown</a></span> against an enemy champion, up to one per unique champion.',
          },
        ],
        ...
        leveling: [
          {
            ...
            effectType: 'Gain',
            increasedStat: 'ultimateHaste',
            values: 6,
            unitsText: 'haste, up to 31 at 5 stacks.',
            children: [
              {
                values: 5,
                unitsText: 'per Bounty Hunter stack',
        ...
        leveling: [
          {
            ...
            values: 0,
            unitsText:
              'Damaging basic attacks, abilities, item effects, and summoner spells, as well as the application of  crowd control and damage over time effects, generate stacks against enemy  champions, up to one per attack or cast per champion',
          ...
          },
          {
            ...
            valuesIsBasedOnLevel: true,
            unitsText: 'physical or magic damage.',
            children: [
              {
                values: 40,
                valuesIsPercent: true,
        ...
        leveling: [
          {
            ...
            values: 4,
            valuesIsPercent: true,
            unitsText: 'bonus AD ≥ 25undefined',
          ...
          },
          {
            ...
            effectType: 'Damage',
            values: 0,
            unitsText: 'If otherwise, deals magic damage.',
        ...
        leveling: [
          {
            ...
            values: 1,
            unitsText:
              'every Ghost Poro spawned and whenever your Ghost Poro spots an enemy champion, up to 10 stacks, for a maximum of 12 bonus Attack Damage or 20 Ability Power',
            children: [
              {
                values: 0,
                unitsText: 'Adaptive',
        ...
        leveling: [
          {
            ...
            valuesIsBasedOnLevel: true,
            unitsText: 'physical or magic damage after a 0.25-second delay.',
            children: [
              {
                values: 25,
                valuesIsPercent: true,
        ...
        leveling: [
          {
            ...
            values: 2,
            valuesIsPercent: true,
            unitsText: 'bonus AD ≥ 15undefined',
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: [
              10, 12.06, 14.12, 16.18, 18.24, 20.29, 22.35, 24.41, 26.47, 28.53,
              30.59, 32.65, 34.71, 36.76, 38.82, 40.88, 42.94, 45,
            ],
            valuesIsBasedOnLevel: true,
            unitsText:
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: [
              20, 22.35, 24.71, 27.06, 29.41, 31.76, 34.12, 36.47, 38.82, 41.18,
              43.53, 45.88, 48.24, 50.59, 52.94, 55.29, 57.65, 60,
            ],
            valuesIsBasedOnLevel: true,
            unitsText:
              'Adaptive damage and, after a 1.75-second delay, reap 1 Soul',
            children: [
              {
                values: 5,
                unitsText: 'per Soul',
        ...
        leveling: [
          {
            ...
            values: 1,
            unitsText:
              'not on cooldown, also reap 1 Soul from receiving the kill credit of a champion killed by a  minion,  monster, or  turret.',
        ...
        leveling: [
          {
            ...
            values: 0,
            unitsText:
              "This effect deals either physical or magic damage depending on the damage contribution from your  attack damage and  ability power to the effect's damage formula.\nGreater bonus damage from the  AD ratio → Physical damage\nGreater bonus damage from the  AP ratio → Magic damage\nIf the damage contribution of  AD and  AP are zero or otherwise equal, the damage type depends on the effect's particular default.",
        ...
        leveling: [
          {
            ...
            effectType: 'Gain',
            values: 2,
            unitsText: 'haste, up to 50 at 5 stacks.',
            children: [
              {
                values: 6,
                unitsText: 'per Bounty Hunter stack',
  ...
  8135: {
    ...
    subskills: [
        ...
        leveling: [
          {
            ...
            effectType: 'Gain',
            values: 7,
            unitsText: 'unique takedown, up to  550 at 5 unique takedowns.',
            children: [
              {
                values: 20,
                unitsText: 'per Bounty Hunter stack',
      ...
      },
      {
        ...
        leveling: [
          {
            name: '1st unique takedown:',
            raw: '  70, 2nd:  90, 3rd:  110, 4th:  130, 5th:  150.',
            damagetype: 'None',
            effectType: 'Unique',
            values: 7,
            unitsText: '2nd:  90, 3rd:  110, 4th:  130, 5th:  150.',
        ...
        leveling: [
          {
            ...
            min: 0,
            max: 10,
            title: 'Scoring a  takedown against an enemy  ward',
            description:
              '<span class="template_sbc"><b>Passive:</b></span> Scoring a <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Takedown"><a href="/wiki/Takedown" title="Takedown"><img alt="Damage rating.png" src="/wiki/images/Damage_rating.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Takedown" title="Takedown">takedown</a></span> against an enemy <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Ward"><a href="/wiki/Ward" title="Ward"><img alt="Ward icon.png" src="/wiki/images/Ward_icon.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Ward" title="Ward">ward</a></span> (excluding <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Zombie ward"><a href="/wiki/Ward#Zombie_Ward" title="Ward#Zombie Ward"><img alt="Zombie Ward icon.png" src="/wiki/images/Farsight_Ward_icon.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Ward#Zombie_Ward" title="Ward">Zombie Wards</a></span>) within 10 seconds of damaging it summons an allied <span class="glossary" style="white-space:pre; position:relative;" data-game="lol" data-tip="Zombie ward"><a href="/wiki/Ward#Zombie_Ward" title="Ward#Zombie Ward"><img alt="Zombie Ward icon.png" src="/wiki/images/Farsight_Ward_icon.png" decoding="async" loading="lazy" width="20" height="20" class="lazyload"></a> <a href="/wiki/Ward#Zombie_Ward" title="Ward">Zombie Ward</a></span> in its place.',
            user: 'player',
            units: 'zombieWardsPlaced',
            unitsText: ' Zombie Wards placed.',
          },
        ],
        locked: true,
        ...
        leveling: [
          {
            ...
            values: 1,
            unitsText:
              'every Zombie Ward spawned, up to 10, for a maximum of 12 bonus Attack Damage or 20 Ability Power',
            children: [
              {
                values: 0,
                unitsText: 'Adaptive',
          ...
          {
            name: 'After spawning 10 Zombie Wards:',
        ...
        leveling: [
          {
            ...
            values: 1,
            unitsText:
              '1 Eyeball whenever scoring a  takedown against an enemy champion, up to 10.',
        ...
        leveling: [
          {
            ...
            values: 1,
            unitsText:
              'Eyeball collected, up to 12 bonus Attack Damage or 20 Ability Power',
            children: [
              {
                values: 0,
                unitsText: 'Adaptive',
        ...
        leveling: [
          {
            ...
            values: 0,
            unitsText:
              'Grants bonuses based on which stat you already have the most bonuses for',
          ...
          },
          {
            ...
            effectType: 'Unique',
            values: 0,
            unitsText: 'Defaults to the first listed.',
        ...
        leveling: [
          {
            ...
            effectType: 'Heal',
            values: [
              16, 16.82, 17.65, 18.47, 19.29, 20.12, 20.94, 21.76, 22.59, 23.41,
              24.24, 25.06, 25.88, 26.71, 27.53, 28.35, 29.18, 30,
            ],
            valuesIsBasedOnLevel: true,
            unitsText: '.',
            children: [
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: 4,
            unitsText: '7 magic penetration for the next 5 seconds.',
            children: [
              {
                values: [
        ...
        leveling: [
          {
            ...
            values: 5,
            valuesIsPercent: true,
            unitsText: '.bonuses upon reaching the following levels:',
    ...
    subskills: [
      {
        ...
        leveling: [
          ...
          },
          {
            ...
            effectType: 'Heal',
            values: [
              30, 32.65, 35.29, 37.94, 40.59, 43.24, 45.88, 48.53, 51.18, 53.82,
              56.47, 59.12, 61.76, 64.41, 67.06, 69.71, 72.35, 75,
            ],
            valuesIsBasedOnLevel: true,
            unitsText: '2 seconds.',
            children: [
        ...
        leveling: [
          {
            ...
            values: 0,
            unitsText:
              'Aery applies her effects to the affected champion upon arrival',
          ...
          },
          {
            ...
            values: 2,
            unitsText:
              'then lingers on the target for 2 seconds before flying back to the user, and cannot be sent out again until she returns',
          ...
          },
          {
            ...
            values: 0,
            unitsText:
              'While on her way back, she is initially very slow, but gradually accelerates, and can be picked up by moving near her.',
        ...
        leveling: [
          {
            ...
            values: 1,
            valuesIsPercent: true,
            unitsText: 'bonus AD ≥ 10undefined',
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: [
              35, 39.41, 43.82, 48.24, 52.65, 57.06, 61.47, 65.88, 70.29, 74.71,
              79.12, 83.53, 87.94, 92.35, 96.76, 101.18, 105.59, 110,
            ],
            valuesIsBasedOnLevel: true,
            unitsText: 'damage for 4 seconds.',
            children: [
              {
                values: 14,
                valuesIsPercent: true,
        ...
        leveling: [
          {
            ...
            values: 2,
            unitsText:
              'an enemy  champion with an ability permanently increases your  maximum mana by 25, up to 250 mana',
          ...
          },
          {
            ...
            values: 0,
            unitsText:
              'Mana gained from this effect preserves your current mana.',
        ...
        leveling: [
          {
            ...
            valuesIsPercent: true,
            unitsText:
              'of your missing mana every 5 seconds.reaching 250 bonus mana, permanently restore 1',
  ...
  8229: {
    ...
    subskills: [
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: [
              30, 34.12, 38.24, 42.35, 46.47, 50.59, 54.71, 58.82, 62.94, 67.06,
              71.18, 75.29, 79.41, 83.53, 87.65, 91.76, 95.88, 100,
            ],
            valuesIsBasedOnLevel: true,
            unitsText:
              'or magic damage to enemies within a  140 radius upon impact.',
            children: [
              {
                values: 35,
                valuesIsPercent: true,
      ...
      },
      {
        ...
        leveling: [
          {
            name: 'Dealing forms of ability damage reduces the remaining cooldown.\n Spell damage:',
            raw: ' 20%\n Area damage: 10% per enemy hit\n Persistent damage: 5%',
            damagetype: 'None',
            effectType: 'Damage',
            values: 20,
            valuesIsPercent: true,
            unitsText: 'Area damage: 10',
            pre: '20%\n Area damage: 10% per enemy hit\n Persistent damage: 5%',
            user: 'player',
        ...
        leveling: [
          {
            ...
            values: 3,
            valuesIsPercent: true,
            unitsText: 'bonus AD ≥ 20undefined',
    ...
    subskills: [
      {
        ...
        leveling: [
          ...
          },
          {
            ...
            values: [],
            valuesIsBasedOnLevel: true,
            unitsText: 'slow resist for 3 seconds.movement speed and 75',
            children: [
              {
                values: 30,
                valuesIsPercent: true,
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: [
              3, 3.88, 4.76, 5.65, 6.53, 7.41, 8.29, 9.18, 10.06, 10.94, 11.82,
              12.71, 13.59, 14.47, 15.35, 16.24, 17.12, 18,
            ],
            valuesIsBasedOnLevel: true,
            unitsText: 'Attack Damage or 5',
            children: [
              {
                values: 0,
                unitsText: 'Adaptive',
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: [
              1.8, 2.75, 3.71, 4.66, 5.61, 6.56, 7.52, 8.47, 9.42, 10.38, 11.33,
              12.28, 13.24, 14.19, 15.14, 16.09, 17.05, 18,
            ],
            valuesIsBasedOnLevel: true,
            unitsText: 'Attack Damage or 3',
            children: [
              {
                values: 0,
                unitsText: 'Adaptive',
        ...
        leveling: [
          {
            ...
            values: 7,
            valuesIsPercent: true,
            unitsText: '.movement speed bonuses increase in effectiveness by 7',
        ...
        leveling: [
          {
            ...
            values: 1,
            valuesIsPercent: true,
            unitsText: 'bonus movement speed.you gain  1',
        ...
        leveling: [
          {
            ...
            unitsText: 'bonus Attack Damage or 0 / 8 / 24 / 48 / 80 / ∞',
            children: [
              {
                values: 0,
        ...
        leveling: [
          {
            ...
            valuesIsBasedOnLevel: true,
            unitsText: 'magic damage after 1 second.',
        ...
        leveling: [
          {
            ...
            values: 5,
            valuesIsPercent: true,
            unitsText: 'slow resist and  tenacity.',
            children: [
              {
                values: 0,
        ...
        leveling: [
          {
            ...
            values: 5,
            valuesIsPercent: true,
            unitsText: 'movement speed for 2 seconds.',
            children: [
              {
                values: 0,
                unitsText: 'based on summoner spell cooldown',
        ...
        leveling: [
          {
            ...
            values: 5,
            valuesIsPercent: true,
            unitsText: 'maximum healthchampions while below 60',
            children: [
              {
                values: 0,
                unitsText: 'except  true damage',
          ...
          },
          {
            ...
            valuesIsPercent: true,
            unitsText:
              'increased damage while below 30increases further based on your missing health, up to 11',
        ...
        leveling: [
          {
            ...
            values: 2,
            unitsText:
              'Flash has a remaining cooldown greater than 2 seconds, it is replaced by  Hexflash.',
        ...
        leveling: [
          {
            ...
            values: 2,
            unitsText:
              "begin  charging for up to 2.5 seconds, increasing Hexflash's range over the duration",
          ...
          },
          {
            ...
            values: 1,
            unitsText:
              'at least 1 second, you can reactivate the spell, which is automatically done so when the charge completes without reactivation',
          ...
          },
          {
            ...
            values: 1,
            unitsText:
              'the charge earlier than 1 second or entering combat with an enemy  champion will put Hexflash on  cooldown for 10 seconds.',
        ...
        leveling: [
          {
            ...
            effectType: 'Unique',
            values: 0,
            unitsText: 'You  blink to the target location within range.',
        ...
        leveling: [
          {
            ...
            effectType: 'Gain',
            values: 1,
            unitsText: ', you receive a  Perfectly Timed Stopwatch',
            children: [
              {
                values: 2,
                unitsText:
                  'by 2 minutes whenever scoring a  takedown against an enemy champion',
          ...
          },
          {
            ...
            values: 2,
            unitsText:
              'Perfectly Timed Stopwatch is identical to the  Stopwatch, except it only contributes for a value of  250',
          ...
          },
          {
            ...
            values: 0,
            unitsText:
              'A  free cosmetic,  Commencing Stopwatch occupies one of your item slots before obtaining a Perfectly Timed Stopwatch.',
        ...
        leveling: [
          {
            ...
            values: 3,
            unitsText:
              'the game with 3 ×  Minion Dematerializers, which can be activated to  execute the target enemy  minion after a 1-second delay',
          ...
          },
          {
            ...
            values: 1,
            unitsText:
              'are placed on a 180-second  cooldown at the start of the game.',
        ...
        leveling: [
          {
            ...
            valuesIsPercent: true,
            unitsText:
              'increased damage to that type of minion for the remainder of the gameaddition to the  gold and  experience obtained from killing the minion, you also gain 6',
          ...
          },
          {
            ...
            valuesIsPercent: true,
            unitsText:
              ', up to a maximum of 12beyond the first used on the same type of minion increases this bonus by 3',
        ...
        leveling: [
          {
            ...
            values: 1,
            unitsText:
              ', which is displayed as negative gold in your treasury.',
            children: [
              {
                values: 5,
                unitsText: 'per minute',
                pre: '+  5 per minute',
                user: 'player',
            ...
            user: 'player',
            units:
              'total_, which is displayed as negative gold in your treasury.',
          },
        ],
        ...
        leveling: [
          {
            ...
            values: 5,
            unitsText:
              '50 lending fee is added onto the amount of gold you owe after leaving the shop.',
        ...
        leveling: [
          {
            ...
            effectType: 'Unique',
            values: 2,
            unitsText: 'Market activates after 2 minutes.',
        ...
        leveling: [
          {
            ...
            values: 2,
            unitsText:
              'a  Total Biscuit of Everlasting Will at 2:00, 4:00, and 6:00',
          ...
          },
          {
            ...
            values: 0,
            unitsText:
              'will appear as soon as a slot in the inventory is available.',
            children: [
              {
                values: 0,
                unitsText: 's',
        ...
        leveling: [
          {
            ...
            values: 4,
            unitsText:
              'a Biscuit will instantly restore  40 mana and permanently increase your maximum mana by the same amount, in addition to its effects',
          ...
          },
          {
            ...
            values: 5,
            unitsText:
              'will also gain the increased mana if you sell the biscuit for  5.',
        ...
        leveling: [
          {
            ...
            effectType: 'Gain',
            values: 1,
            unitsText: '18 summoner spell haste and 10 item haste.',
        ...
        leveling: [
          {
            ...
            valuesIsPercent: true,
            unitsText:
              'against your allies, excluding yourself.have their damage reduced by 15',
            children: [
              {
                values: 3,
                valuesIsPercent: true,
        ...
        leveling: [
          {
            ...
            valuesIsPercent: true,
            unitsText:
              'bonus total movement speed while under the effect of a potion or biscuit.you gain  2',
        ...
        leveling: [
          {
            ...
            values: 5,
            unitsText:
              'not channeling  Teleport and being out-of-combat for 5 seconds, you can swap one of your equipped summoner spells to a new, single use summoner spell',
        ...
        leveling: [
          {
            ...
            values: 6,
            unitsText:
              'first swap becomes available after 6 minutes, with an initial 300 second cooldown',
          ...
          },
          {
            ...
            values: 2,
            unitsText:
              'a unique summoner spell reduces the swap cooldown by 25 seconds',
          ...
          },
          {
            ...
            values: 3,
            unitsText:
              "must swap to 3 different summoner spells before returning to one you've already used.",
        ...
        leveling: [
          {
            ...
            effectType: 'Unique',
            values: 5,
            unitsText: 'a summoner spell puts it on a 5 second cooldown.',
        ...
        leveling: [
          {
            ...
            values: 1,
            unitsText:
              'a selected summoner spell puts the summoner spell in the same slot on a 10 second cooldown.',
        ...
        leveling: [
          {
            ...
            valuesIsPercent: true,
            unitsText:
              'bonus true damagedamage or applying a  crowd control effect to an enemy champion within the first 0.25 seconds of champion combat, grants  5 and First Strike for 3 seconds, causing all of your post-mitigation damage dealt against champions to deal 9',
        ...
        leveling: [
          {
            ...
            values: [
              1, 1.53, 2.06, 2.59, 3.12, 3.65, 4.18, 4.71, 5.24, 5.76, 6.29,
              6.82, 7.35, 7.88, 8.41, 8.94, 9.47, 10,
            ],
            valuesIsBasedOnLevel: true,
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: [
              5, 6.47, 7.94, 9.41, 10.88, 12.35, 13.82, 15.29, 16.76, 18.24,
              19.71, 21.18, 22.65, 24.12, 25.59, 27.06, 28.53, 30,
            ],
            valuesIsBasedOnLevel: true,
            unitsText: 'bonus  Adaptive damage',
            children: [
              {
                values: 1.5,
                valuesIsPercent: true,
          ...
          },
          {
            ...
            values: 2,
            unitsText:
              'empowered attack lasts for up to 2 seconds after the shield expires.',
    ...
    subskills: [
      {
        ...
        leveling: [
          ...
          {
            name: 'Magic Resistance increase:',
            effectType: 'Gain',
            increasedStat: 'bonus_mr',
            values: 3,
            valuesIsPercent: true,
        ...
        leveling: [
          {
            ...
            raw: 'deal bonus magic damage equal to ( 3.5% /  2.1%) of your maximum health',
            damagetype: 'Magic',
            effectType: 'Damage',
            valuesIsPercent: true,
            values: [3.5, 2.1],
            unitsText: 'of your maximum health',
            post: '',
            user: 'player',
            units: 'maximum_hp',
          },
          {
            name: 'Heal:',
            raw: 'heal you for ( 1.7% /  1.02%) of your maximum health',
            damagetype: 'Magic',
            effectType: 'Damage',
            values: [1.7, 1.02],
            valuesIsPercent: true,
            unitsText: 'of your maximum health,  heal you for',
            user: 'player',
            units: 'maximum_hp',
          },
          {
            name: 'Permanent health:',
            raw: 'and permanently grant ( 5 /  3) bonus health.',
            damagetype: 'None',
            effectType: 'Gain',
            increasedStat: 'bonus_hp',
            values: [5, 3],
            unitsText: 'bonus health',
            user: 'player',
            units: 'maximum_hp',
        ...
        leveling: [
          ...
          },
          {
            ...
            values: [
              ...
              117.06, 121.18, 125.29, 129.41, 133.53, 137.65, 141.76, 145.88,
              150,
            ],
            valuesIsBasedOnLevel: true,
            unitsText: '.',
        ...
        leveling: [
          {
            ...
            effectType: 'Damage',
            values: [
              25, 30.59, 36.18, 41.76, 47.35, 52.94, 58.53, 64.12, 69.71, 75.29,
              80.88, 86.47, 92.06, 97.65, 103.24, 108.82, 114.41, 120,
            ],
            valuesIsBasedOnLevel: true,
            unitsText: '',
            children: [
              {
                values: 8,
                valuesIsPercent: true,
                unitsText: 'of your bonus health',
    ...
    subskills: [
      {
        ...
        leveling: [
          {
            name: 'Regenerate:',
            raw: ' 3 (+ 4% of your missing health) health over 10 seconds.',
            damagetype: 'None',
            effectType: 'Heal',
            values: 3,
            unitsText: 'over 10 seconds.',
            children: [
              {
                values: 4,
                valuesIsPercent: true,
                unitsText: 'of your missing health',
  ...
  8446: {
    ...
    subskills: [
      ...
      {
        description: '<i>Demolish</i> activates after 45 seconds of game time.',
        leveling: [],
      },
    ],
  },
        ...
        leveling: [
          {
            ...
            damagetype: 'None',
            effectType: 'Gain',
            increasedStat: 'healAndShieldPower',
            values: 5,
            valuesIsPercent: true,
            unitsText: 'Heal and shield power',
            user: 'player',
            units: '',
          },
        ],
            ...
            children: [
              {
                values: 0.9,
                valuesIsPercent: true,
                unitsText: 'of your <b>maximum</b> health',
        ...
        leveling: [
          {
            ...
            effectType: 'Shield',
            values: [
              45, 79.16, 83.33, 87.5, 91.67, 95.83, 100, 104.17, 108.33, 112.5,
              116.67, 120.83, 125, 129.17, 133.33, 137.5, 120, 120,
            ],
            valuesIsBasedOnLevel: true,
            unitsText: '',
            children: [
              ...
              },
              {
                values: 8,
                valuesIsPercent: true,
                unitsText: "of Guardian's bonus health",
        ...
        leveling: [
          {
            ...
            valuesIsBasedOnLevel: true,
            unitsText: 'less damage',
            pre: 'The same enemy champion deals',
            post: 'less damage (including true damage)',
            user: 'player',
            units: 'flatTrueDamageReduction',
          },
        ],
  ...
  9103: {
    ...
    subskills: [
        ...
        leveling: [
          {
            ...
            values: 0,
            valuesIsPercent: true,
            unitsText: 'life steal per Legend stack, up to 60.4',
      ...
      {
        description:
          '<span class="template_sbc"><b>Legend:</b></span> Gain <i>Legend</i> stacks for every 100 points',
        leveling: [
          {
            effectType: 'Stacks',
            units: 'legendStacks',
        ...
        leveling: [
          {
            ...
            effectType: 'Gain',
            increasedStat: 'tenacity',
            values: 5,
            valuesIsPercent: true,
            unitsText: 'at maximum stacks.up to 20',
            children: [
              {
                values: 1.5,
                valuesIsPercent: true,
  ...
  9923: {
    ...
    subskills: [
      ...
      },
      {
        ...
        leveling: [
          {
            name: 'While Hail of Blades is active:',
