...
export default {
  'Way of the Wanderer': {
    ...
    description: [
      {
        icon: '/wiki/images/Way_of_the_Wanderer.png',
        description:
  ...
  'Steel Tempest': {
    ...
    description: [
      {
        icon: '/wiki/images/Steel_Tempest.png',
        description:
      ...
      {
        icon: '/wiki/images/Steel_Tempest_2.png',
        description:
      ...
      {
        icon: '/wiki/images/Steel_Tempest_3.png',
        description:
  ...
  'Wind Wall': {
    ...
    description: [
      {
        icon: '/wiki/images/Wind_Wall.png',
        description:
  ...
  'Sweeping Blade': {
    ...
    description: [
      {
        icon: '/wiki/images/Sweeping_Blade.png',
        description:
  ...
  'Last Breath': {
    ...
    description: [
      {
        icon: '/wiki/images/Last_Breath.png',
        description:
