    ...
    leveling: [
      {
        ...
        min: 0,
        max: 10,
        description: " Plasma stacks applied by Kai'Sa's basic attacks or  Void Seeker deal 5 − 23 (based on level) (+ 1 − 12 (based on level) per Plasma stack before application) (+ 15% − 25% (based on Plasma stacks before application) AP) bonus magic damage",
        values: [
          5,
          6.06,
          7.12,
            ...
            children: [
              {
                ...
                user: 'player',
                units: 'total_ap',
                unitsText: 'based on Plasma stacks before application',
                pre: 'based on Plasma stacks before application',
              },
            ],
          },
        ],
      },
      {
        ...
        user: 'player',
        units: 'total_ap',
        unitsText: "of the target's missing health, capped at 400 against  monsters",
...
const Q: SubSkill[] = [
  ...
  },
  {
    ...
    leveling: [
      ...
      },
      {
        ...
        raw: '90 / 123.75 / 157.5 / 191.25 / 225 (+ 112.5% bonus AD) (+ 67.5% AP)',
        values: [
          90,
          123.75,
          157.5,
        ...
        units: '',
        unitsText: '',
        pre: '90 / 123.75 / 157.5 / 191.25 / 225',
        children: [
          {
            values: 112.5,
            valuesIsPercent: true,
  ...
  {
    img: '/wiki/images/Kai%27Sa_Icathian_Rain_2.png',
    ...
    leveling: [
      {
        ...
        user: 'player',
        units: 'total_ad',
        unitsText: 'attack damage from items 」「  100 attack damage from items and stat growth 」to upgrade – Icathian Rain instead fires 12 missiles',
        pre: 'Requires「  100 − 66',
...
const W: SubSkill[] = [
  ...
  {
    img: '/wiki/images/Kai%27Sa_Void_Seeker_2.png',
    ...
    leveling: [
      {
        effectType: 'Gain',
        name: 'Line 1:',
        raw: ' Requires「  100% − 70% (based on level) attack speed from items 」「  100% attack speed from items and stat growth 」to upgrade – Supercharge grants  invisibility at the start of the cast time for 0',
        ...
        user: 'player',
        units: '',
        unitsText: 'attack speed from items 」「  100% attack speed from items and stat growth 」to upgrade – Supercharge grants  invisibility at the start of the cast time for 0',
        pre: 'Requires「  100% − 70%',
        post: 'attack speed from items 」「  100% attack speed from items and stat growth 」to upgrade – Supercharge grants  invisibility at the start of the cast time for 0',
      },
    ],
  },
];
