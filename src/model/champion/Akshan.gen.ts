...
export default {
  'Dirty Fighting': {
    ...
    description: [
      {
        icon: '/wiki/images/Dirty_Fighting.png',
        description:
  ...
  'Going Rogue': {
    ...
    description: [
      {
        icon: '/wiki/images/Going_Rogue_2.png',
        description:
      ...
      {
        icon: '/wiki/images/Going_Rogue.png',
        description:
  ...
  'Heroic Swing': {
    ...
    description: [
      ...
      {
        icon: '/wiki/images/Heroic_Swing.png',
        description:
      ...
      {
        icon: '/wiki/images/Heroic_Swing_2.png',
        description:
